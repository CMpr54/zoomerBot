...
s1 = "Мы зарегистрировали вас на уроки и хотим порекомендовать @Coach_the_Gentlebot\nЭто бот, "
s2 = "который поможет вам держать себя в форме и не забывать о тренировках. "
s3 = "Тренер поможет составить персональный план тренировок, будет напоминать о них и следить за вашим прогрессом"
text_of_ad = s1 + s2 + s3
# настройка логов
...
timetable = {"Monday": {
    "9А": ["История", "История", "Алгебра", "Геометрия", "Английский язык", "Физическая культура", "ОБЖ"],
    "10А": ["Физика", "Физика", "Информатика и ИКТ", "Информатика и ИКТ", "История", "История", "Английский язык"]
},
    "Tuesday": {
        "9А": ["Биология", "Физическая культура", "География", "Обществознание", "Русский язык", "Литература"],
        "10А": ["Русский язык", "Литература", "ОБЖ", "Английский язык", "Математика", "Математика",
                "Физическая культура"]
    },

    "Wednesday": {
        "9А": ["Родной язык", "Родная литература", "Информатика и ИКТ", "Физика", "География"],
        "10А": ["Математика", "Математика", "Русский язык", "Литература", "Химия", "Классный час"]
    },
    "Thursday": {
        "9А": ["Алгебра", "Геометрия", "Родной язык", "Английский язык", "Физика", "Химия"],
        "10А": ["Математика", "Математика", "Физика", "Физика", "Физическая культура", "Английский язык"]
    },
    "Friday": {
    ...
    "Saturday": {
        ...
        "10А": ["Обществознание", "Обществознание", "Математика", "Физическая культура", "Родной язык",
                "Родная литература"]
    }
}
...
def send_ad():
    ...
    if weekday == "Sunday":
        return
    for tel_id in dictionary_of_users.keys():
        bot.send_message(tel_id, text_of_ad)
...
schedule.every().day.at("09:30").do(send_ad)
