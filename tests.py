...
timetable = {"Monday": {
    ...
    "10А": ["Физика", "Информатика и ИКТ", "Информатика и ИКТ", "История", "История", "Английский язык"]
                        },
            "Tuesday": {
    "9А": ["Биология", "Физическая культура", "География", "Обществознание", "Русский язык", "Литература"],
    "10А": ["Русский язык", "Литература", "ОБЖ", "Английский язык", "Математика", "Математика", "Физическая культура"]
                        },

            "Wednesday": {
    "9А": ["Родной язык", "Родная литература", "Информатика и ИКТ", "Физика", "География"],
    "10А": ["Математика", "Математика", "Русский язык", "Литература", "Химия"]
                        },
            "Thursday": {
