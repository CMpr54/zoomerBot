    ...
    try:
        if user.conversation_power == 0:
            ...
            if message.text.lower() == "да":
                ...
                bot.send_message(message.chat.id, 'Сколько секунд ты держешь планку?', reply_markup=keyboard_num_strap)
            elif message.text.lower() == "нет":
    ...
    try:
        ...
        if user.conversation == "greeting":
            ...
            if message.text.lower() == 'называй меня по другому':
                ...
                request = apiai.ApiAI('a1fe08a2e45b42c0bba9df6aafaee1c9').text_request()
                request.lang = 'ru'
